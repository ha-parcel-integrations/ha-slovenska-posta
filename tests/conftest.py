"""pytest configuration for the Slovenská Pošta test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.slovenska_posta`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.slovenska_posta import parcels

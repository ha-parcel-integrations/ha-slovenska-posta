"""Tests for the Slovenská Pošta deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.slovenska_posta.calendar import SlovenskaPostaDeliveriesCalendar
...
def _cal(data):
    return SlovenskaPostaDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="Slovenská Pošta Shop")])
    assert cal._events()[0].location == "Slovenská Pošta Shop"
